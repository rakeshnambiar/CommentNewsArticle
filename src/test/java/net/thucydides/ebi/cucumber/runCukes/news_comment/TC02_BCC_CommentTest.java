...
@CucumberOptions(tags = {"@TC02_BCC_CommentTest"},
        format = {"pretty", "html:target/Destination/TC02_BCC_CommentTest",
                "json:target/cucumber-report/TC02_BCC_CommentTest.json"},
...
public class TC02_BCC_CommentTest {
}
